...
u64 len = number of elements currently contained
...
ZAPI void *_darray_create(u64 length, u64 stride);
ZAPI void _darray_destroy(void *array);

ZAPI u64 _darray_field_get(void *array, u64 field);
ZAPI void _darray_field_set(void *array, u64 field, u64 value);

ZAPI void *_darray_resize(void *array);

ZAPI void *_darray_push(void *array, const void *value_ptr);
ZAPI void _darray_pop(void *array, void *dest);

ZAPI void *_darray_pop_at(void *array, u64 idx, void *dest);
ZAPI void *_darray_insert_at(void *array, u64 idx, void *value_ptr);
