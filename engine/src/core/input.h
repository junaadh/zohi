...
// keyboard input
ZAPI b8 input_is_key_down(keys key);
ZAPI b8 input_is_key_up(keys key);
ZAPI b8 input_was_key_down(keys key);
ZAPI b8 input_was_key_up(keys key);

// platform
void input_process_key(keys key, b8 pressed);

// mouse input
ZAPI b8 input_is_button_down(buttons button);
ZAPI b8 input_is_button_up(buttons button);
ZAPI b8 input_was_button_down(buttons button);
ZAPI b8 input_was_button_up(buttons button);
ZAPI void input_get_mouse_position(i32* x, i32* y);
ZAPI void input_get_previous_mouse_position(i32* x, i32* y);
