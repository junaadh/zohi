...
b8 platform_startup(
    ...
    HWND handle = CreateWindowExA(
        window_ex_style, "zohi_window_class", application_name,
...
void platform_get_required_extension_names(const char ***names_darrray) {
...
LRESULT CALLBACK win32_process_message(HWND hwnd, u32 msg, WPARAM w_param, LPARAM l_param) {
    ...
    case WM_MOUSEWHEEL: {
        ...
        if (z_delta != 0) {
            ...
            // pass to the input subsystem
            input_proceinput_process_mouse_wheel(z_delta);
        }
    } break;
    case WM_LBUTTONDOWN:
    case WM_MBUTTONDOWN:
